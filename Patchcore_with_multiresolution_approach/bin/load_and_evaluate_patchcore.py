...
def run(methods, results_path, gpu, seed, save_segmentation_images,
    ...
    dataloader_iter1,n_dataloaders1 =  methods["get_dataloaders_iter"](seed, resize1, imagesize1)
    dataloader_iter2,n_dataloaders2 =  methods["get_dataloaders_iter"](seed, resize2, imagesize2)
    dataloader_iter3,n_dataloaders3 =  methods["get_dataloaders_iter"](seed, resize3, imagesize3)

    dataloader_iter = dataloader_iter1(seed)
    ...
    for dataloader_count, dataloaders in enumerate(dataloader_iter):
        ...
        with device_context:
            ...
            LOGGER.info("Computing evaluation metrics._le")
...
def dataset(
    name, data_path, subdatasets, batch_size, num_workers, augment,
    resize1,resize2, resize3,
    imagesize1, imagesize2, imagesize3,
):
    ...
    def get_dataloaders_iter(seed, resize, imagesize):
