...
def compute_imagewise_retrieval_metrics(
    ...
    ap = average_precision_score(anomaly_ground_truth_labels, anomaly_prediction_weights)
...
def compute_pixelwise_retrieval_metrics(anomaly_segmentations, ground_truth_masks, i = 0, sp=None):
    ...
    ap = average_precision_score(flat_ground_truth_masks.astype(int), flat_anomaly_segmentations)
